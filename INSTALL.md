...
1. 開啟 [v4.0.1 GitHub Release](https://github.com/sink6985757-web/google-drive-desktop-backup-manager/releases/tag/v4.0.1)。
2. 下載 `GoogleDrive_Desktop_Backup_Manager_Total_Installer_v4.0.1.zip`。
3. 在下載資料夾執行：
...
4. 將結果與 [`releases/v4.0.1/SHA256SUMS.txt`](releases/v4.0.1/SHA256SUMS.txt) 比對。
5. 雜湊不符時停止，不要解壓縮或執行。

Repository 內的 [`releases/v4.0.1/`](releases/v4.0.1/) 保存相同 ZIP、SHA-256 與版本說明。v4.0.0 的 Base64 分段只保留作為歷史資料，不應用於新安裝。
